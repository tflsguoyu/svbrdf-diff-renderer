...
if __name__ == "__main__":
    ...
    # optim_ganlatent(json_dir, 256, 0.02, [1000, 10, 10], 
    #     ["ckp/latent_const_W+_256.pt", "ckp/latent_const_N_256.pt"])
    # using average latent W+ and random noise as initial
    optim_ganlatent(json_dir, 256, 0.02, [2000, 10, 10], 
        ["ckp/latent_avg_W+_256.pt"])
